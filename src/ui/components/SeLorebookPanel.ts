...
const S = {
  ...
  stateContainer: { display: "flex", "align-items": "center", "justify-content": "center", padding: "20px", color: "rgba(255,255,255,0.5)", "flex-direction": "column", gap: "8px" },
      ...
      content: [
        ...
        column({
          ...
          content: [
            ...
            text({ text: "Managed entries can be edited via their entity cards.", style: { "font-size": "0.8em", opacity: "0.6", "text-align": "center" } }),
          ],
        }),
