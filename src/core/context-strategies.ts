...
const getAllDulfsContext = (manager: StoryManager, excludeFieldId: string): string => {
    const fields = [
  ...
  async buildDulfsContext(fieldId: string): Promise<StrategyResult> {
    ...
    switch (fieldId) {
        ...
        case FieldID.UniverseSystems:
            userInstruction = "Generate a list of key universe systems, magic rules, or technological principles. Describe the mechanic or rule concisely.";
            exampleFormat = "Format each line as: [System Name]: [Description of mechanic or rule]";
            break;
        case FieldID.Locations:
            userInstruction = "Generate a list of significant locations. Include atmospheric anchors, sensory details, and inherent tensions.";
        ...
        case FieldID.Factions:
            userInstruction = "Generate a list of major factions, guilds, or political groups. Describe their core ideology, goal, and internal structure.";
            exampleFormat = "Format each line as: [Faction Name]: [description of ideology, goal, structure]";
            break;
        case FieldID.SituationalDynamics:
            userInstruction = "Generate a list of current conflicts, pending events, or tensions that involve multiple characters with no suggested resolution.";
