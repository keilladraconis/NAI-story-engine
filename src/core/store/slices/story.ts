...
export const storySlice = createSlice({
  ...
  reducers: {
    ...
    fieldUpdated: (state, payload: { fieldId: string; content: string; data?: any }) => {
    ...
    // DULFS
    dulfsItemAdded: (state, payload: { fieldId: DulfsFieldID; item: DulfsItem }) => {
    ...
    dulfsItemUpdated: (state, payload: { fieldId: DulfsFieldID; itemId: string; updates: Partial<DulfsItem> }) => {
    ...
    dulfsItemRemoved: (state, payload: { fieldId: DulfsFieldID; itemId: string }) => {
    ...
    dulfsSummaryUpdated: (state, payload: { fieldId: string; summary: string }) => ({
        ...state,
        dulfsSummaries: {
