...
describe("GenX", () => {
  ...
  beforeEach(() => {
    ...
    (global as any).api.v1.generate.mockImplementation(
      async (msgs: any, params: any, cb: any) => {
  ...
  it("should handle budget wait (user)", async () => {
    ...
    (global as any).api.v1.hooks.register.mockImplementation(
      (name: string, cb: any) => {
    ...
    (global as any).api.v1.script.getTimeUntilAllowedOutput.mockReturnValue(
      100,
    );
  ...
  it("should handle cancellation during generation", async () => {
    ...
    (global as any).api.v1.generate.mockImplementation(
      async (msgs: any, params: any, cb: any, behavior: any, sig: any) => {
