...
import { type SuiLorebookPanelStateTheme, type SuiLorebookPanelTheme } from "./theme/lorebook-panel.ts";
...
> {
  constructor(options: SuiLorebookPanelOptions<TTheme, TState>, baseTheme = Theme.lorebookPanel as unknown as TTheme) {
