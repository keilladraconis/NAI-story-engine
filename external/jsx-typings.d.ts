...
declare namespace preact {
  ...
  type ComponentChild =
    VNode | string | number | boolean | null | undefined | ComponentChild[];
...
interface ScriptSVGCommonAttributes<
  T = unknown,
> extends ScriptHTMLAttributes<T> {
  transform?: string;
...
interface ScriptSVGGraphicsAttributes<
  T = unknown,
> extends ScriptSVGCommonAttributes<T> {
  fill?: string;
...
interface ScriptSVGTextContentAttributes<
  T = unknown,
> extends ScriptSVGGraphicsAttributes<T> {
...
interface ScriptSVGFilterPrimitiveAttributes<
  T = unknown,
> extends ScriptSVGCommonAttributes<T> {
  x?: number | string;
  y?: number | string;
...
function createImageBitmap(
  source: string | ScriptImageData,
): Promise<ScriptImageBitmap>;
