...
type UIExtensionToolboxOption = {
  ...
  callback?:
    ((_: { selection: DocumentSelection; text: string }) => void) | string;
 ...
 */
type RolloverHelperItem<
  T extends RolloverHelperContentObject = RolloverHelperContentObject,
> = string | T;
 ...
 */
type DecorationMarkerInfo =
  DecorationInlineMarkerInfo | DecorationNodeMarkerInfo;
 ...
 */
type DecorationMarkerEvent =
  DecorationMarkerChangeEvent | DecorationMarkerDisposeEvent;
 ...
 */
type DecorationWidgetInfo =
  DecorationInlineWidgetInfo | DecorationNodeWidgetInfo;
 ...
 */
type DecorationWidgetEvent =
  DecorationWidgetChangeEvent | DecorationWidgetDisposeEvent;
...
type DecorationUpdateWidgetOptions =
  DecorationUpdateInlineWidgetOptions | DecorationUpdateNodeWidgetOptions;

type DecorationCreateWidgetOptions =
  DecorationCreateInlineWidgetOptions | DecorationCreateNodeWidgetOptions;
...
declare namespace api {
  ...
  namespace v1 {
    ...
    namespace editor {
      ...
      namespace decorations {
        ...
        function updateRules(
          updates: (Partial<DecorationRule> & { id: string })[],
        ): Promise<void>;
        ...
        function createWidget<
          T extends DecorationCreateWidgetOptions =
    ...
    function createRolloverHelper<
      T extends RolloverHelperContentObject = RolloverHelperContentObject,
    >(config: RolloverHelperConfig): RolloverHelper<T>;
    ...
    namespace logprobs {
       ...
       * @returns Promise resolving to the current logprobs and model, or null if no logprobs are set
       */
    ...
    namespace lorebook {
      ...
      function createCategory(
        category: Partial<LorebookCategory>,
      ): Promise<string>;
    ...
    namespace ui {
       ...
       */
      function update(
        extensions: Partial<UIExtension>[] & { id: string }[],
      ): Promise<void>;
      ...
      function updateParts(
        parts: Partial<UIPart>[] & { id: string }[],
      ): Promise<void>;
      ...
      namespace part {
         ...
         */
        function textInput(
          config: Omit<UIPartTextInput, "type">,
        ): UIPartTextInput;
        ...
        function numberInput(
          config: Omit<UIPartNumberInput, "type">,
        ): UIPartNumberInput;
        ...
        function checkboxInput(
          config: Omit<UIPartCheckboxInput, "type">,
        ): UIPartCheckboxInput;
         ...
         */
        function container(
          config: Omit<UIPartContainer, "type">,
        ): UIPartContainer;
        ...
        function sliderInput(
          config: Omit<UIPartSliderInput, "type">,
        ): UIPartSliderInput;
         ...
         */
        function codeEditor(
          config: Omit<UIPartCodeEditor, "type">,
        ): UIPartCodeEditor;
      ...
      namespace extension {
        ...
        function scriptPanel(
          config: Omit<UIExtensionScriptPanel, "type">,
        ): UIExtensionScriptPanel;
        ...
        function sidebarPanel(
          config: Omit<UIExtensionSidebarPanel, "type">,
        ): UIExtensionSidebarPanel;
    ...
    namespace hooks {
       ...
       */
      function register<K extends keyof HookCallbacks>(
        hookName: K,
       ...
       */
      function isRegistered<K extends keyof HookCallbacks>(
        hookName: K,
      ): boolean;
    }
...
type OnGenerationRequested = (params: {
  ...
  | void
  | Promise<OnGenerationRequestedReturnValue | void>;
...
type OnGenerationEnd = (params: {
  ...
  | void
  | Promise<OnGenerationEndReturnValue | void>;
...
type OnBeforeContextBuild = (params: {
  ...
  | void
  | Promise<onBeforeContextBuildReturnValue | void>;
...
type OnTextAdventureInput = (params: {
  ...
  | void
  | Promise<OnTextAdventureInputReturnValue | void>;
...
type OnDocumentConvertedToText = (params: {
  ...
  | void
  | Promise<OnDocumentConvertedToTextReturnValue | void>;
